  ...
  if (loading) {
    return (
      <div className="flex-1 flex items-center justify-center">
        ...
        <span className="ml-3 text-slate-500 font-medium">Loading Sales History...</span>
      </div>
    );
  }
          ...
          <table className="w-full text-left border-collapse">
            <thead className="sticky top-0 bg-white z-10 shadow-sm">
              <tr className="border-b border-slate-100">
                <th className="px-6 py-4 text-[11px] font-black text-slate-400 uppercase tracking-tighter">Customer</th>
                <th className="px-6 py-4 text-[11px] font-black text-slate-400 uppercase tracking-tighter">Institution</th>
                <th className="px-6 py-4 text-[11px] font-black text-slate-400 uppercase tracking-tighter">Category</th>
                <th className="px-6 py-4 text-[11px] font-black text-slate-400 uppercase tracking-tighter">Sales Person</th>
                <th className="px-6 py-4 text-[11px] font-black text-slate-400 uppercase tracking-tighter">Completed At</th>
                <th className="px-6 py-4 text-[11px] font-black text-slate-400 uppercase tracking-tighter">Final KPI</th>
              </tr>
            </thead>
                ...
                <tr key={sale.id} className="group hover:bg-slate-50/80 transition-colors">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-bold text-slate-700">{sale.pic}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4">
