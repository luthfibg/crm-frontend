    ...
    <div className="fixed inset-0 z-110 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white dark:bg-slate-800 w-[95%] md:w-[80%] lg:w-[55%] max-w-5xl rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200 max-h-[90vh] flex flex-col">
        <div className="p-6 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center shrink-0 dark:bg-slate-800/50">
          <h3 className="text-lg font-black text-slate-800 dark:text-slate-100">Add New Customer</h3>
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-4 dark:bg-slate-800">
          ...
          <div className="space-y-1">
            <label className="text-[11px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider">Custom Creation Date/Time</label>
            <input 
              type="datetime-local"
            ...
            />
            <p className="text-xs text-slate-400 dark:text-slate-500 mt-1">Leave empty to use current date/time.</p>
          </div>

          <div className="shrink-0 border-t border-slate-100 dark:border-slate-700 p-6 mt-4 dark:bg-slate-800">
